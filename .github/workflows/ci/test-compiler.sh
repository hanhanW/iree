...
ls -la /home/runner/work/iree/iree/.cache/vulkan-sdk/lib/libvulkan.so.1

# TODO(benvanik): make a helper that sets this environment.
# export LD_PRELOAD=libvulkan.so.1
export LD_LIBRARY_PATH=$SWIFTSHADER_PATH:$VULKAN_SDK_PATH/lib/
export LD_LIBRARY_PATH=$VULKAN_SDK_PATH/lib/
export VK_LAYER_PATH=$VULKAN_SDK_PATH/lib/
export VK_LOADER_DEBUG=all
export LD_DEBUG=all

mkdir -p /home/runner/.local/share/vulkan/icd.d/
cp $SWIFTSHADER_PATH/* /home/runner/.local/share/vulkan/icd.d/
...
#     --output-log test.log
LD_LIBRARY_PATH=$SWIFTSHADER_PATH:$VULKAN_SDK_PATH/lib/ \
