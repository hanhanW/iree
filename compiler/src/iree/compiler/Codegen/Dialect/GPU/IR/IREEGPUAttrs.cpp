...
lowerContractionOpWithEncoding(OpBuilder &builder, linalg::LinalgOp linalgOp,
                               ValueRange operands, TargetAttr targetAttr,
                               Codegen::ResolveEncodingInfoFn getEncodingInfo) {
  ...
  assert(succeeded(contractionDims) &&
...
Operation *GPUEncodingLayoutAttr::lowerOp(OpBuilder &b, Operation *op,
  ...
  if (linalg::isaContractionOpInterface(linalgOp)) {
    FailureOr<Operation *> newOp = lowerContractionOpWithEncoding(
        b, linalgOp, convertedOperands, getTargetAttr(), resolver);
